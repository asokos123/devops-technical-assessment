...
* `RESPUESTAS.md`: Documento principal con las respuestas teóricas, análisis de logs de Jenkins, patrones de monitoreo y comandos Linux.
* `health_check.py`: Script automatizado en Python para el chequeo de disponibilidad de URLs.
* `evidencias/`: Carpeta que contiene las capturas de pantalla solicitadas de los recursos en AWS y la ejecución del script.
